...
try:
    ...
    st.error("Spreadsheet not found. Please create it manually or check credentials.")
    st.stop()
...
sites = ['Kaneshie', 'Mallam', 'Tetteh','Achimota','La','Amasaman','Tantra Hill','Graphic Road']
officers = ['Ben', 'Clement', 'Obed','Peter','Mawuli']
